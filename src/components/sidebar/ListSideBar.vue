<template>
    <nav class="mt-4 space-y-5 text-white px-8 py-4">
        <ItemList label="لوحة التحكم" :sidebarCollapsed="sidebarCollapsed" href="/dashboard">
        ...
        <ItemList label="الصفحة الرئيسي" :sidebarCollapsed="sidebarCollapsed" href="/">
            <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path fill="currentColor"
                        d="M3 13h1v7c0 1.103.897 2 2 2h12c1.103 0 2-.897 2-2v-7h1a1 1 0 0 0 .707-1.707l-9-9a1 1 0 0 0-1.414 0l-9 9A1 1 0 0 0 3 13m9-8.586l6 6V15l.001 5H6v-9.586z" />
                    <path fill="currentColor"
        ...
        <ItemList label="الاعدادات" :sidebarCollapsed="sidebarCollapsed" href="/">
            <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path fill="currentColor"
                        d="M3 13h1v7c0 1.103.897 2 2 2h12c1.103 0 2-.897 2-2v-7h1a1 1 0 0 0 .707-1.707l-9-9a1 1 0 0 0-1.414 0l-9 9A1 1 0 0 0 3 13m9-8.586l6 6V15l.001 5H6v-9.586z" />
                    <path fill="currentColor"
